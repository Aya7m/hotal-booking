      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
              ...
              room.images.map((image, index) => (
                <img
                  ...
                  className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${
                    mainImage === image && "outline-2 outline-orange-300"
                  }`}
                />
              ))}
          </div>
        ...
        <div className="mt-10 flex flex-col md:flex-row md:justify-between">
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap mt-3 items-center mb-4 gap-4">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 md:py-3 text-base cursor-pointer"
          >
            {isAvailable ? "Booking Now" : "Check Availability"}
          </button>
        </form>
        ...
        <div className="max-w-3xl border-y border-gray-300 py-10 my-15 text-gray-500">
          <p>
